...
export function GitServiceSetup() {
  return (
      ...
      <Tabs defaultValue="gitea">
          ...
          <Steps>
            <Step number={1} title="使用Docker安装Gitea">
              ...
              <div className="bg-muted p-3 rounded text-sm font-mono">
                ...
                <br /># 启动Gitea容器
                <br />
                docker run -d --name=gitea \<br />
                -p 3000:3000 -p 22:22 \<br />
                -v ~/gitea/data:/data \<br />
                -e USER_UID=1000 -e USER_GID=1000 \<br />
                --restart always \<br />
                gitea/gitea:latest
              </div>
            </Step>
        ...
        <TabsContent value="config" className="space-y-4">
          <Steps>
            ...
            <Step number={2} title="配置本地Git客户端">
        ...
        <TabsContent value="github" className="space-y-4">
          <Steps>
            ...
            <Step number={2} title="配置GitHub远程仓库">
...
export default GitServiceSetup
